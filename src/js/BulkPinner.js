 ...
 * Class BulkPinner
 */
export default class BulkPinner {
    ...
    initAuthorization() {
        ...
        document.querySelector(".authenticate-button").addEventListener('click', () => {
            API.Login()
               .then(({accessToken}) => {
     ...
     */
    initApplication() {
        const clearPreviews = new ClearPreviews();
        ...
        document.querySelector('.refresh-boards').addEventListener('click', () => {
        ...
        document.querySelector('.pins-container').addEventListener('blur', e => {
            if (e.target.matches('.note')) {
                e.target.classList.toggle('invalid', e.target.value !== '');
            }
        });

        document.querySelector('.send-to-pinterest').addEventListener('click', () => {
            if (this.validateInputs()) {
                this.createPins();
            }
        });

        document.getElementById('send-all-to-board').addEventListener('change', e => {
        ...
        input.onchange = e => this.handleImagesSelected(e);
